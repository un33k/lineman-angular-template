...
[![Build Status](https://travis-ci.org/un33k/lineman-angular-template.png?branch=production)](https://travis-ci.org/un33k/lineman-angular-template)
...
9. [Unit Tests](https://github.com/un33k/lineman-angular-template/tree/production/spec) and [End-to-End Tests](https://github.com/un33k/lineman-angular-template/tree/master/spec-e2e)
10. Configuration to run [Protractor](https://github.com/juliemr/protractor) for End-to-End Tests
11. Includes by default: Twitter Bootstrap, Font-Awesome and Github's Octicons
12. Live reload and bower install and asset fingerprint are enabled by default

# Instructions

1. `git clone https://github.com/un33k/lineman-angular-template.git my-lineman-app`
2. `cd my-lineman-app`
